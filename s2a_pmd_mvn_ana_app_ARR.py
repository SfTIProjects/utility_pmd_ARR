##########################################################################################################
# Use this Script if you want to run the PMD static code analysis using Maven                            #
...
# srun python s2a_pmd_mvn_ana_app_ARR.py -t 577 -pd ../my_codesnippet_analysis/pmd/mvn_apps -upd -cf ../my_codesnippet_analysis/pmd/completecodeanalysis -ucf -xrf ../my_codesnippet_analysis/pmd/pmdxmlreports -uxrf -ef ../my_codesnippet_analysis/pmd/errorcodeanalysis -lf ../my_codesnippet_analysis/pmd/pmd_logs.txt
...
def run_pmd_analysis():
    ...
    while error:
        #pmd_cmd = 'cd ../my_codesnippet_analysis/pmd/mvn_apps/my-javacodeanalysis-app0; mvn -e pmd:pmd'
    ...
    if use_xml_rep_files == True:
        ...
        # e.g., mv ../my_codesnippet_analysis/pmd/mvn_apps/my-javacodeanalysis-app0/target/*-result0.xml ../my_codesnippet_analysis/pmd/xmlanalysisreports
